  ...
  return (
    ...
    >
      ...
      <VStack spacing={4} align="center">
        <Avatar size="xl" name="Sundar Gurung" src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQBCY-kwdjyy_QKxaitv4qnQxoXk8GyKewAgQ&s" />
        <Text fontSize="lg" fontWeight="bold">Sundar Gurung</Text>
        <Text fontSize="sm" color="gray.200">sundargurung360@gmail.com</Text>
      </VStack>

      {/* Sidebar Menu */}
      <VStack align="stretch" spacing={4}>
        <Button leftIcon={<FaHome />} variant="ghost" justifyContent="start" w="full">
          Dashboard
        </Button>
        <Button leftIcon={<FaTasks />} variant="ghost" justifyContent="start" w="full">
          Vital Task
        </Button>
        <Button leftIcon={<FaTasks />} variant="ghost" justifyContent="start" w="full">
          My Task
        ...
        <Button leftIcon={<FaCog />} variant="ghost" justifyContent="start" w="full">
          Settings
        </Button>
        <Button leftIcon={<FaQuestionCircle />} variant="ghost" justifyContent="start" w="full">
          Help
        </Button>
      </VStack>
